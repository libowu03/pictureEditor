...
class FaceLandmark {
public:
    FaceLandmark(string faceMark1000ParamPath,string faceMark1000BinPath,string faceBoxParamPath,string faceBoxBinPath);
    void ClearFaceKeyPoint();
    ~FaceLandmark();
